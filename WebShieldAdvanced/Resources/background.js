...
(function (browser) {
  ...
  // Wrap listener to filter out messages handled by background-wrapper.js
  // (whitelist, stats). Return false synchronously so those messages
  // are handled by the other listener instead.
  browser.runtime.onMessage.addListener((request, sender) => {
    if (request.type === 'checkWhitelist' || request.type === 'toggleWhitelist' || request.type === 'getStats') {
      return false;
    }
