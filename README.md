...
>       - There are other ways to join WebShield+ other than financial contributions! Please see the [documentation page on WebShield+](https://github.com/arjpar/WebShield/wiki/WebShield-#webshield).
